...
const dampScroll = (d: number) => {
	...
	uScrollVelocityLerp.value.x = damp2(uScrollVelocityLerp.value.x, velocity.x, 0.01, d);
	uScrollVelocityLerp.value.y = damp2(uScrollVelocityLerp.value.y, velocity.y, 0.01, d);
};
